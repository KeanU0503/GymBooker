...
public class ClassChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chart_class);
        getSupportActionBar().hide();

        PieChart piechart = findViewById(R.id.pieChartClass);
        ...
        PieDataSet pieDataSet = new PieDataSet(entries, " - Class Category");
        ...
        piechart.setCenterText("Total Class Bookings");
    }
}